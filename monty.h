 ...
 * @n: an integer
 * @prev: the point to the previous element of the stack (or queue)
 * @next: the point to the next element of the stack (or queue)
 *
 ...
 * @lifi: to flag change stack <-> queue
 ...
 *
 * Description: an opcode and its function
 * for stack, queues, LIFO, FIFO Holberton project
 */
